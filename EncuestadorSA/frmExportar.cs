...
namespace Encuestador
{
    public partial class frmExportar : Form
    {
        ...
        private bool validar()
        {
            ...
            if (cmbDataEncuesta.SelectedValue == null || int.Parse(cmbDataEncuesta.SelectedValue.ToString()) < 0 || pUsuarioSeleccionado == null)
            {
        ...
        private void cmbUsuarios_DropDown(object sender, EventArgs e)
        {
            ...
            this.cmbDataEncuesta.DropDownWidth = pw;
        }
        ...
        private void frmExportar_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbDataEncuesta.SelectedIndex = -1;
